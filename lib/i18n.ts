...
const translations = {
  es: {
    ...
    alq_casa_desc: "La masía completa para grupos y retiros. Incluye todas las habitaciones, salones, cocina y jardín. Precio basado en personas y días de estancia.",
  ...
  ca: {
    ...
    alq_casa_desc: "La masia completa per a grups i retirs. Inclou totes les habitacions, salons, cuina i jardí. Preu basat en persones i dies d'estada.",
