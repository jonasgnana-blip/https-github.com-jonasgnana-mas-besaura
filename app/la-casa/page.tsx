...
const HABITACIONES = [
  {
    ...
    descripcion:
      "Habitación con camas individuales y cama doble, suelo de madera original, paredes de piedra encalada y lámpara de esparto. Nombrada en honor a la diosa de la naturaleza y la luna.",
  ...
  },
  {
    ...
    descripcion:
      "Habitación con altillo. Camas individuales abajo y arriba, suelo de madera antigua y ventana con contraventanas de madera. Selene, la luna llena, inspira este espacio luminoso.",
    capacidad: "4 personas",
  ...
  },
  {
    ...
    descripcion:
      "Habitación amplia con múltiples camas individuales, estufa de pellets, paredes blancas y luz natural generosa. Hécate guarda los umbrales y los sueños.",
    capacidad: "4 personas",
...
const ESPACIOS_COMUNES = [
  ...
  {
    nombre: "Habitaciones",
    subtitulo: "Tres diosas",
    descripcion:
      "Tres habitaciones únicas de piedra y madera, cada una con su carácter: Artemisa, Selene y Hécate. Paredes de cal, suelos antiguos y luz que entra despacio.",
    imagen: "/images/hab-hecate.jpg",
    ...
    <div className="min-h-screen bg-[#FAFAF6]">
      ...
      <section className="py-16 px-6 max-w-3xl mx-auto text-center">
        ...
        <p className="text-[#2C1810]/75 text-lg leading-relaxed">
          ...
          Dispone de tres habitaciones, salón comedor, sala estar-cocina y la gran sala exterior La Cabanya.
      ...
      <section className="py-20 px-6 bg-[#2A3F24] text-center">
        <div className="max-w-2xl mx-auto">
          ...
          <h2
            ...
            style={{ fontFamily: "var(--font-playfair), Georgia, serif" }}
          >
            Ven a inspirarte y descansar
          </h2>
          <p className="text-[#E8DCC8]/70 mb-3 leading-relaxed">
            <strong className="text-[#E8DCC8]">Alojamiento + desayuno</strong> — 35€/noche por persona
          </p>
          <p className="text-[#E8DCC8]/70 mb-8 leading-relaxed">
            <strong className="text-[#E8DCC8]">Alojamiento + media pensión</strong> — 50€/noche por persona
          </p>
